		...
		return (
			<div className="sec sec-about" style={ style }>
				...
				<div className="summary">
					<p ref="p1">前端基于<a href="https://angularjs.org/" target="_blank">Angular.js</a> (PC端) 及<a href="https://facebook.github.io/react/" target="_blank">React.js</a> (移动端) 实现</p>
					<p ref="p2">后台则由<a href="https://nodejs.org/" target="_blank">Node.js</a> + <a href="http://expressjs.com/" target="_blank">Express</a>框架搭建，数据库为<a href="https://www.mongodb.org/" target="_blank">MongoDB</a></p>
					<p ref="p3">
